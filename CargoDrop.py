...
async def run():
    ...
    await drone.action.goto_location(
        latitude_deg=33.8616594,      # TODO: Replace with target lat
        longitude_deg=-118.2516835,      # TODO: Replace with target lon
        absolute_altitude_m=abs_alt + 4,    # TODO: Replace with target absolute altitude (not relative! sea level is 0)
